...
Oproto.DrawColourImage = function (c, x, y, w, h, colour, tag, x1, y1) {
  ...
  if (!ocanvas) return this.SetMethod("outline");
  cc = ocanvas.getContext("2d");
...
function TagCanvas(cid, lctr, opt) {
  ...
  this.radius = min(c.height, c.width) * 0.0075;
  this.max_radius = 100;
  this.max_weight = [];
  this.min_weight = [];
...
var TagsCanvas = function TagsCanvas(_ref) {
  var width = _ref.width,
      height = _ref.height,
      tags = _ref.tags,
      _ref$weight = _ref.weight,
      weight = _ref$weight === void 0 ? true : _ref$weight,
      _ref$weightFrom = _ref.weightFrom,
      weightFrom = _ref$weightFrom === void 0 ? 'data-weight' : _ref$weightFrom,
      className = _ref.className,
      options = _objectWithoutPropertiesLoose(_ref, ["width", "height", "tags", "weight", "weightFrom", "className"]);

  var _React$useState = React.useState('a' + uuidv4()),
      id = _React$useState[0];

  React.useEffect(function () {
    TagCanvas.Start(id, id + "-tags", _extends({
      weight: weight,
  ...
  return /*#__PURE__*/React.createElement("canvas", {
  ...
  }, /*#__PURE__*/React.createElement("ul", null, tags.map(function (tag) {
    if (tag.value) {
    ...
    return /*#__PURE__*/React.createElement("li", {
      key: tag
    }, /*#__PURE__*/React.createElement("a", null, tag));
  }))));
};

exports.default = TagsCanvas;
